...
## Project
- Embedded Project: [OTA-Development-Wireless-Updates](https://github.com/aloHyomora/OTA-Prototype-Development-All-About-Wireless-Updates-), [Dachshund-Engine: 실시간 IoT 센서 모니터링 시스템](https://github.com/aloHyomora/Dachshund-Engine),[Embedded-CI-Lab Embedded firmware development and CI/CD automation for testing on ARM Cortex using QEMU](https://github.com/aloHyomora/Embedded-CI-Lab)
